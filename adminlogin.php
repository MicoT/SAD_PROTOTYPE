...
header("Location: SAD_PROTOTYPE/doctor/doctordashboard.php");
}
    ...
    <body>
        <div class="container">
            <div class="login-container">
                    <div id="output"></div>
                    <img src="asset/img/logo.jpg" alt="" height="100px">
                    <div class="form-box">
                        <form class="form" role="form" method="POST" accept-charset="UTF-8">
                            <input name="doctorId" type="text" placeholder="Therapist ID" required>
