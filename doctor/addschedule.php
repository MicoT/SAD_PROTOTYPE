        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="doctordashboard.php">Dynamic Process Therapy Center</a>
                </div>
                <!-- Top Menu Items -->
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li class="active">
                            <a href="addschedule.php"><i class="fa fa-fw fa-table"></i> Therapist Schedule</a>
                        </li>
                        <li>
                               ...
                               <div class="col-md-12 col-sm-12 col-xs-12">
                                <form class="form-horizontal" method="post">
                                 ...
                                 <div class="form-group form-group-lg">
                                  ...
                                  <div class="col-sm-10">
                                   <input type="text" class="form-control" id="scheduleday" name="scheduleday" required>
                                  </div>
                                 </div>
                                 <div class="form-group form-group-lg">
                                 ...
                                 <div class="form-group form-group-lg">
                                  ...
                                  <div class="col-sm-10">
                                   <select class="select form-control" id="bookavail" name="bookavail" readonly>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Therapist" disabled></th>
